...
sleep 5
make clean PROJ_NUM=2.0.2 DOXY_VER=2.4.0
make docs PROJ_NUM=2.0.2 DOXY_VER=2.4.0
cd -
...
sleep 5
make clean PROJ_NUM=1.3.1 DOXY_VER=2.4.0
make docs PROJ_NUM=1.3.1 DOXY_VER=2.4.0
echo ""
