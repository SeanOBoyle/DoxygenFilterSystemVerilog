...
sleep 5
make clean PROJ_NUM=1.0.0 DOXY_VER=2.6.0
make docs PROJ_NUM=1.0.0 DOXY_VER=2.6.0
echo ""
echo "Making OVM 1.0.1 Docs"
sleep 5
make clean PROJ_NUM=1.0.1 DOXY_VER=2.6.0
make docs PROJ_NUM=1.0.1 DOXY_VER=2.6.0
echo ""
echo "Making OVM 1.1.0 Docs"
sleep 5
make clean PROJ_NUM=1.1.0 DOXY_VER=2.6.0
make docs PROJ_NUM=1.1.0 DOXY_VER=2.6.0
echo ""
echo "Making OVM 2.0.0 Docs"
sleep 5
make clean PROJ_NUM=2.0.0 DOXY_VER=2.6.0
make docs PROJ_NUM=2.0.0 DOXY_VER=2.6.0
echo ""
echo "Making OVM 2.0.1 Docs"
sleep 5
make clean PROJ_NUM=2.0.1 DOXY_VER=2.6.0
make docs PROJ_NUM=2.0.1 DOXY_VER=2.6.0
echo ""
echo "Making OVM 2.0.2 Docs"
sleep 5
make clean PROJ_NUM=2.0.2 DOXY_VER=2.6.0
make docs PROJ_NUM=2.0.2 DOXY_VER=2.6.0
echo ""
echo "Making OVM 2.0.3 Docs"
sleep 5
make clean PROJ_NUM=2.0.3 DOXY_VER=2.6.0
make docs PROJ_NUM=2.0.3 DOXY_VER=2.6.0
echo ""
...
sleep 5
make clean PROJ_NUM=1.1.1 DOXY_VER=2.6.0
make docs PROJ_NUM=1.1.1 DOXY_VER=2.6.0
echo ""
echo "Making VMM 1.2.0 Docs"
sleep 5
make clean PROJ_NUM=1.2.0 DOXY_VER=2.6.0
...
sleep 5
make clean PROJ_NUM=1.62c DOXY_VER=2.6.0
make docs PROJ_NUM=1.62c DOXY_VER=2.6.0
cd -
...
sleep 5
make clean PROJ_NUM=1.3.1 DOXY_VER=2.6.0
make docs PROJ_NUM=1.3.1 DOXY_VER=2.6.0
echo ""
